...
const DirectDelivery: React.FC = () => {
    ...
    const loadDeliveries = async () => {
        try {
            ...
            const data = await deliveryService.getDeliveryOrdersDetailed('DIRECT');
    ...
    const handleFormSuccess = async (savedHeader: any, savedItems: any[]) => {
        ...
        if (!editingDO) {
            try {
                ...
                const detailedDO = await deliveryService.getDeliveryOrdersDetailed('DIRECT');
